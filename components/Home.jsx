...
export const Home = () => {
  return (
    <div>### Confiez vos rêves à des experts du Web
    ...
    Notre agence web est capable de répondre à tous vos besoins et d'élaborer une véritable stratégie digitale.</div>
  )
}
